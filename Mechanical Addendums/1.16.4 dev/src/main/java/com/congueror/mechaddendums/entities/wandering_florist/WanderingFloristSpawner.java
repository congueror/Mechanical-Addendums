...
public class WanderingFloristSpawner {
    ...
    public WanderingFloristSpawner(ServerWorld p_i50177_1_) {
        this.world = p_i50177_1_;
        this.field_221248_c = 1200;
        WanderingFloristWorldData worldinfo = WanderingFloristWorldData.get(p_i50177_1_);
    ...
    public void tick() {
        if (this.world.getGameRules().getBoolean(GameRules.DO_TRADER_SPAWNING) && --this.field_221248_c <= 0) {
            this.field_221248_c = 1200;
            WanderingFloristWorldData worldinfo = WanderingFloristWorldData.get(world);
    ...
    private boolean func_221245_b() {
        ...
        if (playerentity == null) {
            ...
            if (blockpos2 != null && this.func_226559_a_(blockpos2)) {
                ...
                WanderingFloristEntity entityPlagueDoctor = (WanderingFloristEntity)EntityInit.WANDERING_FLORIST.get().spawn(this.world, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, blockpos2, SpawnReason.EVENT, false, false);
