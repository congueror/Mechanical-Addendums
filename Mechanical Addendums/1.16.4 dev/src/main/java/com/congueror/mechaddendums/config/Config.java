...
public class Config {
    ...
    static {
        ...
        OreConfig.setupOreConfig(COMMON_BUILDER, CLIENT_BUILDER);
        WorldConfig.setupTreeConfig(COMMON_BUILDER, CLIENT_BUILDER);
        WorldConfig.setupFeatureConfig(COMMON_BUILDER, CLIENT_BUILDER);
        COMMON_BUILDER.pop();
